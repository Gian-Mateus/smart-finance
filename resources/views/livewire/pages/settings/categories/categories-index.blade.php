...
>
	...
	<div class="flex flex-col gap-1">
		...
		<div class="relative">
			<x-collapse class="w-full overflow-visible relative z-10" separator id="{{ uniqid() }}">
			   <x-slot:heading>
				   <div class="flex items-center justify-between relative">
					   ...
					   <!-- Dropdown em posição absoluta que "escapa" do collapse -->
					   <div class="absolute -right-6 top-1/2 -translate-y-1/2 z-[999]">
						   <x-dropdown no-x-anchor right>
							   <x-slot:trigger>
								   <x-button icon="m-ellipsis-vertical" class="btn-ghost"/>
							   </x-slot:trigger>
							   
							   <x-menu-item icon="o-trash" responsive title="Excluir" />
